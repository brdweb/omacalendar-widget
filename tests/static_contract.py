...
class StaticContractTest(unittest.TestCase):
    ...
    def test_manifest_identity_and_compatibility(self) -> None:
        ...
        self.assertEqual(release["testedOmaCalendarVersion"], "1.1.0")
    ...
    def test_public_install_sources_are_release_bound(self) -> None:
        ...
        self.assertIn("release_version=0.1.3", readme)
        ...
        self.assertIn("exact commit of signed tag `v0.1.3`", submission)
